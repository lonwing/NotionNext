...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Joioi AI', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'All-in-one AI Tools', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.joioi.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI tools,AI content genertor,AI images genertor', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'joioiai@gmail.com', // 邮箱地址 例如mail@tangly1024.com
